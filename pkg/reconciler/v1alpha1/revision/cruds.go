...
func (c *Reconciler) createKPA(ctx context.Context, kpa *kpa.PodAutoscaler) (*kpa.PodAutoscaler, error) {
	return c.ServingClientSet.AutoscalingV1alpha1().PodAutoscalers(kpa.Namespace).Create(kpa)
}

func (c *Reconciler) updateKPA(ctx context.Context, kpa *kpa.PodAutoscaler) (*kpa.PodAutoscaler, error) {
	return c.ServingClientSet.AutoscalingV1alpha1().PodAutoscalers(kpa.Namespace).Update(kpa)
}
